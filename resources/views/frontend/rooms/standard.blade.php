...
@section('content')
    ...
    <section id="informations" class="section section-object bg-dark cover dark">
        ...
        <!-- BG Image -->
        <div class="bg-image-holder bg-image-fixed"><img src="{{ asset('images/standard_main.jpg') }}" alt=""></div>
        ...
        <div class="container object-single" data-local-scroll>
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <h1 class="mb-0">
                        <span class="mr-3">STANDARD ROOM</span>
                    </h1>
                </div>
                ...
                <div class="col-lg-10 push-lg-1">
                    ...
                    <article class="post single mt-3">
                        <div class="post-content">
                            ...
                            <figure class="figure">
                                <img src="{{ asset('images/standard/standard_1.jpg') }}" class="figure-img img-fluid rounded" alt="...">
                            </figure>
                            <figure class="figure">
                                <img src="{{ asset('images/standard/standard_2.jpg') }}" class="figure-img img-fluid rounded" alt="...">
                            </figure>
                            <figure class="figure">
                                <img src="{{ asset('images/standard/standard_3.jpg') }}" class="figure-img img-fluid rounded" alt="...">
                            </figure>
                            <figure class="figure">
                                <img src="{{ asset('images/standard/standard_4.jpg') }}" class="figure-img img-fluid rounded" alt="...">
                            </figure>
                            <figure class="figure">
                                <img src="{{ asset('images/standard/standard_5.jpg') }}" class="figure-img img-fluid rounded" alt="...">
                            </figure>
                            <figure class="figure">
                                <img src="{{ asset('images/standard/standard_6.jpg') }}" class="figure-img img-fluid rounded" alt="...">
                            </figure>
                        </div>
                    </article>
